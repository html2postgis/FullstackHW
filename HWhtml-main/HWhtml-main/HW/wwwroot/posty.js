...
address2 = { City: "Gdynia", StreetAddress: "aleja Jana Pawła II 13A", Postcode: "81-345", Lat: 54.51836062977857, Lng: 18.554938498326116, person: receiver };
order = { PickupAddress: address, DeliveryAddress: address2, PackageWeight: 1 };
...
address = {
    ...
    City: "Białystok", StreetAddress: " Jana Kilińskiego 1", Postcode: " 15 - 089", Lat: 53.131310235862166, Lng: 23.16554980337253, person: sender
};
address2 = {
...
//--------VEHICLES---------
var vehicle = {
    MaxCapacity: 5, CurrentCapacity: 0, PlateNumber: "WG 12345", Lat: 52.428764724430046, Lng: 22.118630649005794
}
...
vehicle = {
    MaxCapacity: 10, CurrentCapacity: 0, PlateNumber: "WG 67890", Lat: 51.31796586918416, Lng: 18.289306799540803
}
$.ajax({
    method: "POST",
    url: "Vehicle/Action1",
...
vehicle = {
    MaxCapacity: 15, CurrentCapacity: 0, PlateNumber: "WG 00000", Lat: 53.34373834525721, Lng: 16.573615297052534
}
$.ajax({
    method: "POST",
    url: "Vehicle/Action1",
...
const depotCoords = [52.232014, 21.006039];
vehicle = {
    MaxCapacity: 5, CurrentCapacity: 0, PlateNumber: "WG 12345", Lat: depotCoords[0], Lng: depotCoords[1]
}
...
vehicle = {
    MaxCapacity: 10, CurrentCapacity: 0, PlateNumber: "WG 67890", Lat: depotCoords[0], Lng: depotCoords[1]
}
$.ajax({
    method: "POST",
    url: "Vehicle/Action1",
...
vehicle = {
    MaxCapacity: 15, CurrentCapacity: 0, PlateNumber: "WG 00000", Lat: depotCoords[0], Lng: depotCoords[1]
}
$.ajax({
    method: "POST",
    url: "Vehicle/Action1",
